...
system('cls');
system('Admin Control Panel Finder v1.0 IN HARYANA HACKERS');
system "color 0a";
print"\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\t> [!]Admin Control Panel Finder v1.0                 >\n";
print "\t>                [!]Developed By HARYANA HACKERS                 >\n";
print "\t>       ======================================       >\n";
print "\t> [!]Please Visite ==> haryanahackers.com      >\n";
print "\t> [!]Contact Us ==> haryanahackers@protonmail.com         >\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\n";
